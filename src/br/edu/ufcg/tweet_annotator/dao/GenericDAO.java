...
import br.edu.ufcg.tweet_annotator.dao.connector.ConnPostgreSQL;
...
public class GenericDAO {
	...
	public Connection getConnection() throws SQLException {
		...
		if (this.conn != null && !this.conn.isClosed())
			...
			this.conn = ConnPostgreSQL.getDBConection();
	...
	public Connection getGeoConnection() throws SQLException {
		
		this.conn = ConnPostgreSQL.getGeoDBConection();
		return this.conn;
	}
}
