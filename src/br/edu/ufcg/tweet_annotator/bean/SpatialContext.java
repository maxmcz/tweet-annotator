...
public class SpatialContext extends Context {
	...
	private static final long serialVersionUID = -6616121463979053030L;

	public SpatialContext(Integer id) {
		this.setId(id);
	}
	
	public static SpatialContext getInstance(Integer contextId) {
		
		SpatialContextDAO dao = new SpatialContextDAO();
