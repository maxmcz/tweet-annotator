...
public class SentimentContext extends Context {

	private static final long serialVersionUID = 3658571785696506434L;

	public SentimentContext(Integer id) {
		this.setId(id);
	}
	
	public static SentimentContext getInstance(Integer contextId) {
		
		SentimentContextDAO dao = new SentimentContextDAO();
